...
<h4><i class=icon-reorder></i> Tambah Portfolio</h4>
<span class=tools>
<a href=javascript: class=icon-chevron-down></a>
</span>
</div>
<div class=widget-body>
<form name=tambah_lokasi action=../aksi_admin/aksi_tambah_port1.php class=form-horizontal method=POST enctype=multipart/form-data>
