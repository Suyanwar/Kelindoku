...
<h4><i class=icon-reorder></i> Tambah Video</h4>
<span class=tools>
<a href=javascript: class=icon-chevron-down></a>
</span>
</div>
<div class=widget-body>
<form name=tambah_video action=../aksi_admin/aksi_tambah_video.php class=form-horizontal method=POST enctype=multipart/form-data>
<div class=control-group>
<label class=control-label>Nama Video</label>
<div class=controls>
<input type=text placeholder="Masukan nama video yang baru" class=input-xlarge name=judul required/>
</div>
</div>
<div class=control-group>
<label class=control-label>Link</label>
<div class=controls>
<input type=text placeholder="Masukan bobot" class=input-xlarge name=link required/>
</div>
</div>
<div class=control-group>
