...
<h4><i class=icon-reorder></i> Tambah Event</h4>
<span class=tools>
<a href=javascript: class=icon-chevron-down></a>
</span>
</div>
<div class=widget-body>
<form name=tambah_jasa action=../aksi_admin/aksi_tambah_event.php class=form-horizontal method=POST enctype=multipart/form-data>
<div class=control-group>
<label class=control-label>Nama Event</label>
<div class=controls>
<input type=text placeholder="Masukan nama event" class=input-xlarge name=nama required/>
</div>
</div>
<div class=control-group>
...
<textarea cols=60 rows=5 id=posting name=detail required/></textarea>
</div>
</div>
</div>
<div class=control-group>
