...
<h4><i class=icon-reorder></i> Tambah Mobil</h4>
<span class=tools>
<a href=javascript: class=icon-chevron-down></a>
</span>
</div>
<div class=widget-body>
<form name=tambah_mobil action=../aksi_admin/aksi_tambah_mobil.php class=form-horizontal method=POST enctype=multipart/form-data>
<div class=control-group>
<label class=control-label>Nama</label>
<div class=controls>
<input type=text placeholder="Masukan Nama Mobil" class=input-xlarge name=nama required/>
</div>
</div>
<div class=control-group>
<label class=control-label>Lokasi</label>
<div class=controls>
<select class="input-medium m-wrap" tabindex=1 name=lokasi required/>
<?php
                                                $query = mysqli_query($connection, "SELECT * FROM lokasi_kategori");
                                                 $no = 1;
                                                while ($coba = mysqli_fetch_array($query, MYSQLI_BOTH)){
                                            ?>
...
<textarea cols=60 rows=5 id=posting name=isi required/></textarea>
</div>
</div>
</div>
<div class=control-group>
