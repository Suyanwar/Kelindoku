...
<?php
        $id = $_GET['id'];
        $sql = mysqli_query($connection, "SELECT * FROM lokasi_kategori where id_lk='$id'") or die(mysqli_error());
...
<h4><i class=icon-reorder></i> Edit Lokasi</h4>
<span class=tools>
<a href=javascript: class=icon-chevron-down></a>
</span>
</div>
<div class=widget-body>
<form name=edit_lokasi action=../aksi_admin/aksi_edit_lokasi.php class=form-horizontal method=POST enctype=multipart/form-data>
<input type=hidden name=id value=<?php echo $id; ?> />
<div class=control-group>
<label class=control-label>Lokasi</label>
<div class=controls>
<input type=text placeholder="Masukan Lokasi" class=input-xlarge name=lokasi value=<?php echo $data['lokasi'] ?> required/>
</div>
</div>
<div class=control-group>
...
<div class="fileupload-new thumbnail" style=width:200px;height:150px><img src=../gambar/Lokasi/<?php echo $data['gambar'] ?> alt /></div>
