...
<?php
        $id = $_GET['id'];
        $sql = mysqli_query($connection, "SELECT * FROM client where id='$id'") or die(mysqli_error());
...
<h4><i class=icon-reorder></i> Edit Client</h4>
<span class=tools>
<a href=javascript: class=icon-chevron-down></a>
</span>
</div>
<div class=widget-body>
<form name=edit_lokasi action=../aksi_admin/aksi_edit_client.php class=form-horizontal method=POST enctype=multipart/form-data>
<input type=hidden name=id value=<?php echo $id; ?> />
<div class=control-group>
<label class=control-label>Gambar</label>
<div class=controls>
<div class="fileupload fileupload-new" data-provides=fileupload>
<div class="fileupload-new thumbnail" style=width:200px;height:150px><img src=../gambar/Client/<?php echo $data['gambar'] ?> alt /></div>
