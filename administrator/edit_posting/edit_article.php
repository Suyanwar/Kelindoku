...
<?php
        $id = $_GET['id'];
        $sql = mysqli_query($connection, "select * from article where article_id='$id'") or die(mysqli_error());
...
<textarea cols=60 rows=5 id=posting name=isi><?php echo $data['isi'] ?></textarea>
</div>
</div>
</div>
<div class=control-group>
...
<div class=controls>
<input type=text placeholder="Masukan Harga" class=input-xlarge name=isi1 value=<?php echo $data['harga'] ?> />
</div>
</div>
<div class=control-group>
...
<div class=controls>
<div id=div-1 class="body collapse in">
<textarea cols=60 rows=5 id=posting2 name=isi2><?php echo $data['fasilitas'] ?></textarea>
</div>
</div>
</div>
<div class=control-group>
...
<div class=controls>
<div id=div-1 class="body collapse in">
<textarea cols=60 rows=5 id=posting3 name=isi3><?php echo $data['extras'] ?></textarea>
</div>
</div>
</div>
<div class=control-group>
...
<div class=controls>
<div id=div-1 class="body collapse in">
<textarea cols=60 rows=5 id=posting4 name=isi4><?php echo $data['perkap'] ?></textarea>
</div>
</div>
</div>
<div class=control-group>
...
<div class=controls>
<div id=div-1 class="body collapse in">
<textarea cols=60 rows=5 id=posting5 name=isi5><?php echo $data['rundown'] ?></textarea>
</div>
</div>
</div>
<div class=control-group>
...
<div class="fileupload-new thumbnail" style=width:200px;height:150px><img src=../gambar/Article/<?php echo $data['gambar1'] ?> alt /></div>
...
<div class=controls>
<div class="fileupload fileupload-new" data-provides=fileupload>
<div class="fileupload-new thumbnail" style=width:200px;height:150px><img src=../gambar/Article/<?php echo $data['gambar2'] ?> alt /></div>
<div class="fileupload-preview fileupload-exists thumbnail" style=max-width:200px;max-height:150px;line-height:20px></div>
<div>
<span class="btn btn-file btn-primary">
<span class=fileupload-new>Select image</span>
...
<div class=controls>
<div class="fileupload fileupload-new" data-provides=fileupload>
<div class="fileupload-new thumbnail" style=width:200px;height:150px><img src=../gambar/Article/<?php echo $data['gambar3'] ?> alt /></div>
<div class="fileupload-preview fileupload-exists thumbnail" style=max-width:200px;max-height:150px;line-height:20px></div>
<div>
<span class="btn btn-file btn-primary">
<span class=fileupload-new>Select image</span>
...
<div class=controls>
<input type=text placeholder="Masukan Link Youtube" class=input-xlarge name=isi6 value="<?php echo $data['link'] ?>"/>
</div>
</div>
<div class=control-group>
