...
<?php
                                     ...
                                     $sql = mysqli_query($connection, "SELECT * FROM mobil where lokasi = 'jogjakarta'");
                    $no = 1;
...
<?php
                                     ...
                                     $query1 = mysqli_query($connection, "SELECT * FROM mobil where lokasi = 'jogjakarta'");
                    $no = 1;
